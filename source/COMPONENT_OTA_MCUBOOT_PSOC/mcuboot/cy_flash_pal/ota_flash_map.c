...
#ifndef CY_BOOT_PRIMARY_1_OFFSET
#define CY_BOOT_PRIMARY_1_OFFSET                (0x018000u)
#endif

#ifndef CY_BOOT_EXTERNAL_FLASH_PRIMARY_2_OFFSE
#define CY_BOOT_EXTERNAL_FLASH_PRIMARY_2_OFFSET (0x03E200u)
#endif

#ifndef SWAP_STATUS_PARTITION_SIZE
...
#define CY_BOOT_EXTERNAL_FLASH_SCRATCH_OFFSET   (0x00440000) //CY_BOOT_SCRATCH_START
#endif
...
static struct flash_area primary_1 =
{
    ...
    .fa_device_id = FLASH_DEVICE_INTERNAL_FLASH,
    .fa_off       = CY_FLASH_BASE + CY_BOOT_PRIMARY_1_OFFSET,
...
static struct flash_area secondary_1 =
{
    ...
    .fa_off       = CY_SMIF_BASE_MEM_OFFSET + CY_BOOT_EXTERNAL_FLASH_SECONDARY_1_OFFSET,
...
static struct flash_area primary_2 =
{
    ...
    .fa_device_id = FLASH_DEVICE_EXTERNAL_FLASH(CY_BOOT_EXTERNAL_DEVICE_INDEX),
    .fa_off       = CY_SMIF_BASE_MEM_OFFSET + CY_BOOT_EXTERNAL_FLASH_PRIMARY_2_OFFSET,
...
static struct flash_area secondary_2 =
{
    ...
    .fa_device_id = FLASH_DEVICE_EXTERNAL_FLASH(CY_BOOT_EXTERNAL_DEVICE_INDEX),
    .fa_off       = CY_SMIF_BASE_MEM_OFFSET + CY_BOOT_EXTERNAL_FLASH_SECONDARY_2_OFFSET,
